...
namespace Finanse.Charts {
    public class DoughnutChartCopy : UserControl {
        public DataTemplate ItemTemplate {
            get; set;
        }

        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register(nameof(ItemsSource), typeof(IList), typeof(DoughnutChartCopy), new PropertyMetadata(null, OnItemsSourceChanged));
        ...
        private static void OnItemsSourceChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            var chart = d as DoughnutChartCopy;
        ...
        public static readonly DependencyProperty ThicknessProperty =
            DependencyProperty.Register(nameof(Thickness), typeof(double), typeof(DoughnutChartCopy), new PropertyMetadata(10d, PropertyChangedDelegate));
        ...
        public static readonly DependencyProperty DistanceProperty =
            DependencyProperty.Register(nameof(Distance), typeof(double), typeof(DoughnutChartCopy), new PropertyMetadata(5d, PropertyChangedDelegate));
        ...
        private static PropertyChangedCallback PropertyChangedDelegate = (s, a) => (s as DoughnutChartCopy)?.Redraw();
    }
}
